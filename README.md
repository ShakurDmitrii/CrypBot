...
�������:
- mini app ����� �������� �� `http://127.0.0.1:8080`;
- ���� SQLite �������� � docker volume `bot_data` � �� �������� ����� ����������� �����������;
- �� ������ `bot` ������������� ��������� `alembic upgrade head`.

## ���������� ������ (Render)

� ������� ���� `render.yaml` ��� one-click ������: `miniapp` (web), `bot` (worker) � PostgreSQL.

1. ������������������ �� Render � ���������� GitHub-�����������.
2. ������� ������ �� Blueprint (`render.yaml`).
3. ��������� ������� � Render ��� ����� ��������:
   - `BOT_TOKEN`
   - `BOT_OPERATOR_CHAT_ID`
   - `BOT_OPERATOR_IDS`
   - `BOT_OPERATOR_USERNAME` (�����������)
   - `BOT_OFFER_URL`
4. ����� ������� ������ ������� URL ������� `nebo-miniapp` (���� `https://...onrender.com`) � ��������� ��� �������� � `BOT_MINI_APP_URL` � ������� `nebo-bot`.
5. ������������� ������ `nebo-bot`, ����� � Telegram ��������� `/start`.

�����:
- `DATABASE_URL` ������� �� managed PostgreSQL �������������;
- � ���� ���� ���������������� `postgres://` -> `postgresql+asyncpg://`, ������� ����������� �� Render �������� ��� ������ ������ URL.
